...
},{"./game":9,"./renderer":29,"./utils/debug-output":34,"./utils/frame-driver":35,"./utils/game-state":36,"./utils/input-handler":37,"./utils/timer":38,"std":33}],2:[function(require,module,exports){
/**
...
},{"std":33}],8:[function(require,module,exports){
...
},{"./data/brick-shapes":6,"std":33}],9:[function(require,module,exports){
...
},{"./fail-menu":7,"./game-core":8,"./start-menu":10,"std":33}],10:[function(require,module,exports){
var ref$, id, log, wrap, menuData, limiter, primeGameState, chooseOption, selectPrevItem, selectNextItem, out$ = typeof exports != 'undefined' && exports || this;
ref$ = require('std'), id = ref$.id, log = ref$.log, wrap = ref$.wrap;
menuData = [
  {
...
},{"std":33}],11:[function(require,module,exports){
...
out$.ArenaCells = ArenaCells = (function(superclass){
  ...
  function ArenaCells(opts, gs){
    ...
    this.mats.zap = new THREE.MeshPhongMaterial({
      color: 0xffffff,
      emissive: 0xffffff
    });
...
},{"../palette":30,"./base":13,"std":33}],12:[function(require,module,exports){
...
},{"./arena-cells":11,"./base":13,"./falling-brick":17,"./frame":18,"./guide-lines":19,"./particle-effect":23,"std":33}],13:[function(require,module,exports){
...
},{"std":33}],14:[function(require,module,exports){
...
},{"./base":13,"./brick":15,"std":33}],15:[function(require,module,exports){
var ref$, id, log, div, pi, Base, meshMaterials, Brick, out$ = typeof exports != 'undefined' && exports || this;
...
out$.Brick = Brick = (function(superclass){
  ...
  function Brick(opts, gs){
    var size, grid, res$, i$, i, cube;
    this.opts = opts;
    Brick.superclass.apply(this, arguments);
    size = this.opts.blockSize;
    grid = this.opts.gridSize;
    this.brick = new THREE.Object3D;
    this.frame = new THREE.Mesh(new THREE.BoxGeometry(4 * grid, 4 * grid, grid), new THREE.MeshBasicMaterial({
      color: 'white',
      wireframe: true
    }));
    ...
    for (i$ = 0; i$ <= 3; ++i$) {
      i = i$;
      cube = new THREE.Mesh(this.geom.brickBox, new THREE.MeshNormalMaterial);
      this.brick.add(cube);
      res$.push(cube);
    }
    this.cells = res$;
...
},{"../palette":30,"./base":13,"std":33}],16:[function(require,module,exports){
...
},{"./base":13,"std":33}],17:[function(require,module,exports){
...
},{"./base":13,"./brick":15,"std":33}],18:[function(require,module,exports){
...
},{"./base":13,"std":33}],19:[function(require,module,exports){
...
},{"../palette":30,"./base":13,"std":33}],20:[function(require,module,exports){
...
},{"./base":13,"std":33}],22:[function(require,module,exports){
var ref$, id, sin, lerp, log, floor, map, split, pi, tau, Base, NixieTube, NixieDisplay, out$ = typeof exports != 'undefined' && exports || this, slice$ = [].slice;
...
NixieTube = (function(superclass){
  var digitMats, res$, i$, i, bgMat, glassMat, baseMat, prototype = extend$((import$(NixieTube, superclass).displayName = 'NixieTube', NixieTube), superclass).prototype, constructor = NixieTube;
  res$ = [];
  for (i$ = 0; i$ <= 9; ++i$) {
    i = i$;
    res$.push(new THREE.MeshPhongMaterial({
      map: THREE.ImageUtils.loadTexture("/assets/digit-" + i + ".col.png"),
      transparent: true,
      color: 0xff3300,
      emissive: 0xffbb00
    }));
  ...
  bgMat = new THREE.MeshPhongMaterial({
    map: THREE.ImageUtils.loadTexture('assets/digit-bg.col.png'),
    color: 0x000000,
    transparent: true,
    specular: 0xffffff,
    shininess: 80
  ...
  prototype.createDigitQuad = function(digit, ix){
    ...
    return quad = new THREE.Mesh(geom, digitMats[digit]);
  };
  return NixieTube;
}(Base));
...
},{"../geometry/capsule":28,"./base":13,"std":33}],23:[function(require,module,exports){
...
},{"../palette":30,"./base":13,"std":33}],24:[function(require,module,exports){
...
},{"./base":13,"./title":26,"std":33}],25:[function(require,module,exports){
...
out$.Table = Table = (function(superclass){
  ...
  function Table(opts, gs){
    var ref$, width, depth, thickness, tableMats, tableGeo;
    this.opts = opts;
    ...
    tableMats = {
      top: new THREE.MeshPhongMaterial({
        map: THREE.ImageUtils.loadTexture('assets/board.col.png'),
        specular: 0xffffff,
        specularMap: THREE.ImageUtils.loadTexture('assets/board.spec.png'),
        shininess: 100
      }),
      front: new THREE.MeshPhongMaterial({
        map: THREE.ImageUtils.loadTexture('assets/board-f.col.png')
      })
    };
    tableGeo = new THREE.BoxGeometry(width, thickness, depth);
    this.table = new THREE.Mesh(tableGeo, new THREE.MeshFaceMaterial([tableMats.front, tableMats.front, tableMats.top, tableMats.front, tableMats.front, tableMats.front]));
...
},{"../palette":30,"./base":13,"std":33}],26:[function(require,module,exports){
...
},{"../palette":30,"./base":13,"std":33}],27:[function(require,module,exports){
...
},{"std":33}],28:[function(require,module,exports){
var pi;
pi = require('std').pi;
...
},{"std":33}],29:[function(require,module,exports){
...
},{"../../lib/trackball-controls.js":5,"./components":20,"./debug-camera":27,"./palette":30,"./scene-manager":31,"std":33,"three-js-vr-extensions":4}],30:[function(require,module,exports){
var THREE, ref$, log, map, pluck, neutral, red, orange, green, magenta, blue, brown, yellow, cyan, colorOrder, tileColors, specColors, tileNormalMap, tileNormalAdjust, meshMaterials, i, color, transparentTileMaterials, lineMaterials, Palette, out$ = typeof exports != 'undefined' && exports || this;
THREE = require('three-js-vr-extensions');
...
tileNormalMap = THREE.ImageUtils.loadTexture('/assets/tile.nrm.png');
tileNormalAdjust = new THREE.Vector2(1, 1);
out$.meshMaterials = meshMaterials = (function(){
  ...
  for (i$ = 0, len$ = (ref$ = tileColors).length; i$ < len$; ++i$) {
    ...
    results$.push(new THREE.MeshPhongMaterial({
      ...
      normalScale: tileNormalAdjust
    }));
  }
  return results$;
}());
out$.transparentTileMaterials = transparentTileMaterials = (function(){
  var i$, ref$, len$, results$ = [];
  for (i$ = 0, len$ = (ref$ = tileColors).length; i$ < len$; ++i$) {
    i = i$;
    color = ref$[i$];
...
},{"std":33,"three-js-vr-extensions":4}],31:[function(require,module,exports){
...
},{"std":33,"three-js-vr-extensions":4}],32:[function(require,module,exports){
...
},{"std":33}],33:[function(require,module,exports){
var id, log, flip, delay, floor, random, rand, randInt, randomFrom, addV2, filter, pi, tau, pow, sin, cos, min, max, lerp, map, split, join, unlines, div, wrap, limit, raf, that, Ease, out$ = typeof exports != 'undefined' && exports || this;
...
},{"./easing":32}],34:[function(require,module,exports){
...
},{"std":33}],35:[function(require,module,exports){
...
},{"std":33}],36:[function(require,module,exports){
...
},{"./timer":38,"std":33}],37:[function(require,module,exports){
...
},{"./timer":38,"std":33}],38:[function(require,module,exports){
...
//# sourceMappingURL=data:application/json;base64,
